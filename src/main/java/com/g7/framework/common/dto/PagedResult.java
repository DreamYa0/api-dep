...
/**
 * <p>
 * PagedResult.Builder<GetAttachmentDto> builder = new PagedResult.Builder<>()
 * builder.total((int) page.getTotal()).currentPage(req.getPage().getCurrentPage()).pageSize(req.getPage().getPageSize()).data(collect).buildForSuccess()
 * </p>
 * @author dreamyao
 * @title
...
public class PagedResult<E> extends Result<List<E>> {
    ...
    public static class Builder<E> {
        ...
        public Builder<E> sid(String sid) {
        ...
        public PagedResult<E> buildForSuccess(List<E> data) {
            if (data == null) {
                pagedResult.data(new ArrayList<E>(1));
            } else {
                this.pagedResult.data(data);
            }
